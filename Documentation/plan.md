...
- Remaining for this task: manual simulator verification (Tests AC #2) before this branch ships — the enriched baseline data set above is intended to make that check easy to perform.

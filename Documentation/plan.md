...
- Remaining for this task: event indexing (`[3/n]`), the facade type wiring everything together (`[4/n]`+), and the remaining test categories (single-mutation-no-full-rebuild instrumentation, O(1)-lookup-under-large-N, cold-load-exactly-once).

...
- Remaining for this task: add the memoization cache to `MonthCalendarRowOverlayLayoutBuilder.makeWeekLayouts`, now that the `Hashable` constraint makes it safe, with its own cache-hit/miss tests.

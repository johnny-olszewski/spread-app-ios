...
- Remaining for this task: `EntryStatusIcon` full-replacement rendering path + call sites (AC3); enable via `userEditableTaskStatuses` reorder + shared-array refactor + rotation/exclusion regression tests (AC1, AC2, AC5, AC6).

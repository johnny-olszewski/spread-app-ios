...
- Remaining for this task: none functionally: all ACs covered by tests except AC5's "task/note rows visually unchanged" and the general visual sweep, which need a manual look at the previews/simulator per the note above.

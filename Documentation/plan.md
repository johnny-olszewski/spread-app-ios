...
- Remaining for this task: restructure `MonthSpreadContentView` to pin its calendar grid and wire `OverdueCardView` into its scrollable region; manual visual verification across all 4 views.

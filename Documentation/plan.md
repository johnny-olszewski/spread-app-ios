...
- Remaining for this task: calendar-color tint on the status icon (promote `Entry.iconColor` to a protocol requirement, resolved-color rule with subdued terminal tint, `EntryRowView.statusButton` wiring, previews + resolved-color tests) — AC1, tint half of AC2/AC3, AC5 verification.

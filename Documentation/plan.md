...
### [SPRD-248] Refactor: Additive JournalRuleEngine consolidating the pure logic seams - [ ] In Progress
...
- Remaining for this task: Inbox resolution (`[2/n]`), migration planning + `EntryMigrationCandidate` (`[3/n]`), overdue evaluation (`[4/n]`), assignment reconciliation (`[5/n]`).

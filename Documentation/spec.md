...
- Horizontal spread-title navigator behavior: [SPRD-126, SPRD-127]
  ...
  - The currently selected spread is centered in the strip on launch and whenever selection changes from any non-strip source. [SPRD-126, SPRD-127]
  - The selected spread is rendered as a prominent rounded capsule; any disclosure affordance is unified with the title and not a separate tap target. [SPRD-126, SPRD-127]

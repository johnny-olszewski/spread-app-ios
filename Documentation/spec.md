...
- Spread content view shows active entries and migrated entries section (conventional). [SPRD-27, SPRD-29]
  ...
  - If a multiday card's corresponding explicit day spread does not exist, the card uses an uncreated treatment affecting both header text and card container styling. [SPRD-149]
  ...
  - Every multiday day card includes an always-visible footer with a single trailing `.glassEffect` icon button. [SPRD-149]

...
///   with the legacy `SwiftDataTaskRepository`. Once SPRD-249's cutover deletes that legacy
///   type, rename this to `SwiftDataTaskRepository` (see SPRD-245's renaming plan).
@MainActor
